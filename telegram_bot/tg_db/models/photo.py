...
class Category(Base):
    ...
    name = Column(String(100), unique=True, nullable=False, collation="utf8mb4_bin") 
...
class Photo(Base):
    ...
    file_path = Column(String(255), unique=True, nullable=False, collation="utf8mb4_bin")
    category_id = Column(Integer,  foreign_key=ForeignKey("categories.id", ondelete="SET NULL"), index=True)
